...
def freq_test_1():
    morphology = TurkishMorphology.create_with_defaults()
    bigrams_collocations_frequency = partOfSpeechFilter(FileOperation.ReadCSV("n-grams4/bigrams.json"), 2, morphology)
    FileOperation.writeToCSV(bigrams_collocations_frequency, "results/bigrams_collocations_frequency")

def freq_test_2():
    morphology = TurkishMorphology.create_with_defaults()
    trigrams_collocations_frequency = partOfSpeechFilter(FileOperation.ReadCSV("n-grams4/trigrams.json"), 3, morphology)
    FileOperation.writeToCSV(trigrams_collocations_frequency, "results/trigrams_collocations_frequency")
...
def t_test():
    ...
    FileOperation.writeToCSV(trigrams_collocations_tTest, "results/trigrams_collocations_tTest")

def t_test1():
    #TTEST
    bigrams_collocations_tTest = tTest(FileOperation.ReadCSV("n-grams2/bigrams.json"))
    FileOperation.writeToCSV(bigrams_collocations_tTest, "results/bigrams_collocations_tTest")

def t_test2():
    trigrams_collocations_tTest = tTest(FileOperation.ReadCSV("n-grams2/trigrams.json"))
    FileOperation.writeToCSV(trigrams_collocations_tTest, "results/trigrams_collocations_tTest")